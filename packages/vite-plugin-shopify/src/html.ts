...
const viteTagDisclaimer = `{% doc %}
  Renders Vite entrypoint script and stylesheet tags.

  @param {string} entry - The entrypoint path to load (e.g., 'theme.js', 'theme.css')
  @param {boolean} [preload_stylesheet] - Whether to preload stylesheets (production only)
